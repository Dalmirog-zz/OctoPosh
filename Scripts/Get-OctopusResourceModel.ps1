...
function Get-OctopusResourceModel
{
    ...
    (
        ...
        [ValidateSet('Environment','Project','ProjectGroup','NugetFeed','LibraryVariableSet','Machine','Lifecycle','Team','User')]         
        [string]$Resource
    )
    ...
    Process
    {
        Switch ($Resource){ 
            ...
            'User' {$o = New-Object Octopus.Client.Model.UserResource}
        }      
    }
    End
    {
